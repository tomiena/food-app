...
export const FOODS: Food[] = [
  ...
  { id: "apple",            name: "りんご",       category: "vegetable", image: "/images/foods/apple.png",         water: 84, sodium:  0, potassium: 120, phosphorus:  10,
    portions: [{ label: "1/2個(120g)", amountG: 120 }, { label: "1個(240g)", amountG: 240 }] },
  { id: "banana",           name: "バナナ",       category: "vegetable", image: "/images/foods/banana.png",        water: 75, sodium:  0, potassium: 360, phosphorus:  27,
    portions: [{ label: "1本(90g)", amountG: 90 }, { label: "2本", amountG: 180 }] },
  { id: "mandarin_orange",  name: "みかん",       category: "vegetable", image: "/images/foods/mandarin-orange.png", water: 87, sodium:  1, potassium: 150, phosphorus:  15,
    portions: [{ label: "1個(80g)", amountG: 80 }, { label: "2個", amountG: 160 }] },
  ...
  { id: "reduced_salt_soy", name: "減塩醤油",       category: "seasoning",     image: "/images/foods/low-sodium-soy-sauce.png", water: 67, sodium: 3500, potassium: 390, phosphorus: 150,
    portions: [{ label: "小匙1(6g)", amountG: 6 }, { label: "大匙1(18g)", amountG: 18 }] },
  { id: "ponzu",            name: "ポン酢",         category: "seasoning",     image: "/images/foods/ponzu.png",            water: 74, sodium: 1700, potassium: 200, phosphorus:  50,
    portions: [{ label: "小匙1(5g)", amountG: 5 }, { label: "大匙1(15g)", amountG: 15 }] },
  { id: "worcester_sauce",  name: "ソース",         category: "seasoning",     image: "/images/foods/worcester_sauce.png",  water: 60, sodium: 3300, potassium: 440, phosphorus:  60,
    portions: [{ label: "小匙1(6g)", amountG: 6 }, { label: "大匙1(18g)", amountG: 18 }] },
  { id: "mentsuyu",         name: "めんつゆ（2倍）", category: "seasoning",    image: "/images/foods/mentsuyu.png",         water: 70, sodium: 3000, potassium: 250, phosphorus: 100,
    portions: [{ label: "小匙1(5g)", amountG: 5 }, { label: "大匙1(15g)", amountG: 15 }] },

  // ── drink 追加分 ───────────────────────────────────────────
  { id: "low_fat_milk",     name: "低脂肪乳",       category: "drink", image: "/images/foods/low_fat_milk.png",     water: 90, sodium:  44, potassium: 170, phosphorus:  95,
    portions: [{ label: "半分(100ml)", amountG: 100 }, { label: "コップ1杯(200ml)", amountG: 200 }] },
  { id: "soy_milk",         name: "豆乳（無調整）", category: "drink", image: "/images/foods/soy-milk.png",         water: 91, sodium:   2, potassium: 190, phosphorus:  55,
    portions: [{ label: "半分(100ml)", amountG: 100 }, { label: "コップ1杯(200ml)", amountG: 200 }, { label: "350ml", amountG: 350 }] },
  { id: "drinking_yogurt",  name: "飲むヨーグルト", category: "drink", image: "/images/foods/drinkable-yogurt.png",  water: 85, sodium:  50, potassium: 180, phosphorus: 100,
    portions: [{ label: "半分(100ml)", amountG: 100 }, { label: "コップ1杯(200ml)", amountG: 200 }] },
  { id: "sports_drink",     name: "スポーツドリンク", category: "drink", image: "/images/foods/sports-drink.png",  water: 94, sodium:  49, potassium:  20, phosphorus:   5,
    portions: [{ label: "半分(250ml)", amountG: 250 }, { label: "1本(500ml)", amountG: 500 }] },
  { id: "sparkling_water",  name: "炭酸水",         category: "drink", image: "/images/foods/sparkling-water.png",  water: 100, sodium:  0, potassium:   0, phosphorus:   0,
    portions: [{ label: "半分(250ml)", amountG: 250 }, { label: "1本(500ml)", amountG: 500 }] },
  { id: "lemon_water",      name: "レモン水",       category: "drink", image: "/images/foods/lemon-water.png",      water: 99, sodium:   0, potassium:  10, phosphorus:   2,
    portions: [{ label: "コップ1杯(200ml)", amountG: 200 }, { label: "350ml", amountG: 350 }] },
  { id: "lactic_drink",     name: "乳酸菌飲料",     category: "drink", image: "/images/foods/probiotic-drink.png",     water: 75, sodium:  50, potassium:  40, phosphorus:  30,
    portions: [{ label: "小瓶(65ml)", amountG: 65 }, { label: "大瓶(130ml)", amountG: 130 }] },
  { id: "milk_tea",         name: "ミルクティー",   category: "drink", image: "/images/foods/milk-tea.png",         water: 92, sodium:  30, potassium:  80, phosphorus:  40,
    portions: [{ label: "カップ1杯(150ml)", amountG: 150 }, { label: "コップ1杯(200ml)", amountG: 200 }] },
  { id: "canned_coffee",    name: "缶コーヒー",     category: "drink", image: "/images/foods/canned-coffee.png",    water: 90, sodium:  30, potassium:  60, phosphorus:  30,
    portions: [{ label: "缶1本(185ml)", amountG: 185 }, { label: "大缶(250ml)", amountG: 250 }] },
  { id: "veggie_smoothie",  name: "野菜スムージー", category: "drink", image: "/images/foods/vegetable-smoothie.png",  water: 87, sodium:  50, potassium: 250, phosphorus:  30,
    portions: [{ label: "半分(125ml)", amountG: 125 }, { label: "1本(250ml)", amountG: 250 }] },

  // ── meat 追加分 ────────────────────────────────────────────
  { id: "chicken_sasami",   name: "鶏ささみ",       category: "meat", image: "/images/foods/chicken-tenderloin.png",   water: 75, sodium:  40, potassium: 410, phosphorus: 220,
    portions: [{ label: "1本(50g)", amountG: 50 }, { label: "2本(100g)", amountG: 100 }, { label: "3本(150g)", amountG: 150 }] },
  { id: "chicken_wing_tip", name: "手羽先",         category: "meat", image: "/images/foods/chicken-wings.png", water: 70, sodium:  70, potassium: 200, phosphorus: 170,
    portions: [{ label: "1本(60g)", amountG: 60 }, { label: "3本(180g)", amountG: 180 }] },
  { id: "chicken_wing_root",name: "手羽元",         category: "meat", image: "/images/foods/chicken-drumettes.png",water: 68, sodium:  70, potassium: 240, phosphorus: 190,
    portions: [{ label: "1本(80g)", amountG: 80 }, { label: "2本(160g)", amountG: 160 }] },
  { id: "ground_chicken",   name: "鶏ひき肉",       category: "meat", image: "/images/foods/ground-chicken.png",   water: 70, sodium:  60, potassium: 290, phosphorus: 190,
    portions: [{ label: "少なめ(80g)", amountG: 80 }, { label: "普通(100g)", amountG: 100 }, { label: "多め(150g)", amountG: 150 }] },
  { id: "pork_thin",        name: "豚こま肉",       category: "meat", image: "/images/foods/sliced-pork.png",        water: 64, sodium:  60, potassium: 290, phosphorus: 180,
    portions: [{ label: "少なめ(80g)", amountG: 80 }, { label: "普通(100g)", amountG: 100 }, { label: "多め(150g)", amountG: 150 }] },
  { id: "pork_belly",       name: "豚バラ肉",       category: "meat", image: "/images/foods/pork-belly.png",       water: 53, sodium:  60, potassium: 250, phosphorus: 130,
    portions: [{ label: "少なめ(80g)", amountG: 80 }, { label: "普通(100g)", amountG: 100 }, { label: "多め(150g)", amountG: 150 }] },
  { id: "pork_loin",        name: "豚ロース",       category: "meat", image: "/images/foods/pork-loin.png",        water: 63, sodium:  55, potassium: 310, phosphorus: 200,
    portions: [{ label: "1枚(80g)", amountG: 80 }, { label: "大きめ1枚(120g)", amountG: 120 }] },
  { id: "beef_thin",        name: "牛こま肉",       category: "meat", image: "/images/foods/thinly-sliced-beef.png",        water: 60, sodium:  60, potassium: 290, phosphorus: 170,
    portions: [{ label: "少なめ(80g)", amountG: 80 }, { label: "普通(100g)", amountG: 100 }, { label: "多め(150g)", amountG: 150 }] },
  { id: "beef_sliced",      name: "牛薄切り肉",     category: "meat", image: "/images/foods/sliced-beef.png",      water: 68, sodium:  60, potassium: 290, phosphorus: 175,
    portions: [{ label: "少なめ(80g)", amountG: 80 }, { label: "普通(100g)", amountG: 100 }, { label: "多め(150g)", amountG: 150 }] },
  { id: "mixed_ground",     name: "合いびき肉",     category: "meat", image: "/images/foods/ground-meat.png",     water: 60, sodium:  65, potassium: 280, phosphorus: 165,
    portions: [{ label: "少なめ(80g)", amountG: 80 }, { label: "普通(100g)", amountG: 100 }, { label: "多め(150g)", amountG: 150 }] },
  { id: "bacon",            name: "ベーコン",       category: "meat", image: "/images/foods/bacon.png",            water: 47, sodium: 800, potassium: 220, phosphorus: 140,
    portions: [{ label: "1枚(20g)", amountG: 20 }, { label: "3枚(60g)", amountG: 60 }] },
  { id: "sausage",          name: "ソーセージ",     category: "meat", image: "/images/foods/sausages.png",          water: 55, sodium: 740, potassium: 220, phosphorus: 130,
    portions: [{ label: "1本(25g)", amountG: 25 }, { label: "3本(75g)", amountG: 75 }, { label: "5本(125g)", amountG: 125 }] },
  { id: "tsukune",          name: "つくね",         category: "meat", image: "/images/foods/tsukune.png",          water: 60, sodium: 550, potassium: 250, phosphorus: 170,
    portions: [{ label: "1本(40g)", amountG: 40 }, { label: "3本(120g)", amountG: 120 }] },

  // ── fish 追加分 ────────────────────────────────────────────
  { id: "grilled_salmon",   name: "さけ（焼き）",   category: "fish", image: "/images/foods/grilled-salmon.png",   water: 65, sodium:  70, potassium: 320, phosphorus: 260,
    portions: [{ label: "1切れ(80g)", amountG: 80 }, { label: "大きめ(120g)", amountG: 120 }] },
  { id: "salted_salmon",    name: "さけ（塩鮭）",   category: "fish", image: "/images/foods/salted-salmon.png",    water: 55, sodium: 1100, potassium: 300, phosphorus: 220,
    portions: [{ label: "1切れ(80g)", amountG: 80 }, { label: "大きめ(120g)", amountG: 120 }] },
  { id: "grilled_mackerel", name: "さば（焼き）",   category: "fish", image: "/images/foods/grilled-mackerel.png", water: 57, sodium: 130, potassium: 300, phosphorus: 250,
    portions: [{ label: "1切れ(80g)", amountG: 80 }, { label: "大きめ(120g)", amountG: 120 }] },
  { id: "aji",              name: "あじ",           category: "fish", image: "/images/foods/horse-mackerel.png",              water: 73, sodium: 120, potassium: 360, phosphorus: 220,
    portions: [{ label: "小1尾(70g)", amountG: 70 }, { label: "1尾(100g)", amountG: 100 }] },
  { id: "buri",             name: "ぶり",           category: "fish", image: "/images/foods/yellowtail.png",             water: 67, sodium:  65, potassium: 380, phosphorus: 130,
    portions: [{ label: "1切れ(80g)", amountG: 80 }, { label: "大きめ(120g)", amountG: 120 }] },
  { id: "tara",             name: "たら",           category: "fish", image: "/images/foods/cod.png",             water: 81, sodium: 130, potassium: 350, phosphorus: 220,
    portions: [{ label: "1切れ(80g)", amountG: 80 }, { label: "大きめ(120g)", amountG: 120 }] },
  { id: "sanma",            name: "さんま",         category: "fish", image: "/images/foods/pacific-saury.png",            water: 55, sodium: 130, potassium: 200, phosphorus: 180,
    portions: [{ label: "1尾(120g)", amountG: 120 }] },
  { id: "shishamo",         name: "ししゃも",       category: "fish", image: "/images/foods/smelt.png",         water: 72, sodium: 520, potassium: 280, phosphorus: 390,
    portions: [{ label: "2尾(40g)", amountG: 40 }, { label: "4尾(80g)", amountG: 80 }] },
  { id: "shirasu",          name: "しらす",         category: "fish", image: "/images/foods/whitebait.png",          water: 86, sodium: 300, potassium: 200, phosphorus: 200,
    portions: [{ label: "小匙2(10g)", amountG: 10 }, { label: "大匙1(15g)", amountG: 15 }, { label: "大匙3(40g)", amountG: 40 }] },
  { id: "tuna_can",         name: "ツナ缶",         category: "fish", image: "/images/foods/canned-tuna.png",         water: 85, sodium: 230, potassium: 230, phosphorus: 170,
    portions: [{ label: "半分(40g)", amountG: 40 }, { label: "1缶(80g)", amountG: 80 }] },
  { id: "mackerel_can",     name: "さば缶",         category: "fish", image: "/images/foods/canned-mackerel.png",     water: 72, sodium: 450, potassium: 270, phosphorus: 200,
    portions: [{ label: "半分(100g)", amountG: 100 }, { label: "1缶(200g)", amountG: 200 }] },
  { id: "sardine_can",      name: "いわし缶",       category: "fish", image: "/images/foods/canned-sardines.png",      water: 70, sodium: 400, potassium: 280, phosphorus: 220,
    portions: [{ label: "半分(75g)", amountG: 75 }, { label: "1缶(150g)", amountG: 150 }] },
  { id: "tako",             name: "たこ",           category: "fish", image: "/images/foods/octopus.png",             water: 81, sodium: 280, potassium: 290, phosphorus: 160,
    portions: [{ label: "少量(50g)", amountG: 50 }, { label: "普通(100g)", amountG: 100 }] },

  // ── dairy_egg_soy 追加分 ───────────────────────────────────
  { id: "atsuage",          name: "厚揚げ",         category: "dairy_egg_soy", image: "/images/foods/atsuage.png", water: 75, sodium:   5, potassium: 150, phosphorus: 120,
    portions: [{ label: "半丁(75g)", amountG: 75 }, { label: "1丁(150g)", amountG: 150 }] },

  // ── vegetable 追加分 ───────────────────────────────────────
  { id: "mushroom",         name: "きのこ類",       category: "vegetable",     image: "/images/foods/mushrooms.png",        water: 91, sodium:   2, potassium: 290, phosphorus: 100,
    portions: [{ label: "少量(30g)", amountG: 30 }, { label: "普通(50g)", amountG: 50 }, { label: "多め(100g)", amountG: 100 }] },
  { id: "wakame",           name: "わかめ（戻し）", category: "vegetable",     image: "/images/foods/wakame.png",          water: 97, sodium: 840, potassium: 730, phosphorus:  80,
    portions: [{ label: "少量(10g)", amountG: 10 }, { label: "普通(20g)", amountG: 20 }] },

  // ── 丼もの ─────────────────────────────────────────────────
  { id: "oyako_don",        name: "親子丼",       category: "prepared_food", image: "/images/foods/oyakodon.png",        water: 65, sodium: 250, potassium: 130, phosphorus: 100,
  ...
  { id: "chuka_don",        name: "中華丼",       category: "prepared_food", image: "/images/foods/chukadon.png",        water: 65, sodium: 300, potassium: 150, phosphorus:  80,
    portions: [{ label: "半分(200g)", amountG: 200 }, { label: "1杯(400g)", amountG: 400 }] },
  { id: "soboro_don",       name: "そぼろ丼",     category: "prepared_food", image: "/images/foods/soborodon.png",       water: 63, sodium: 280, potassium: 120, phosphorus:  90,
    portions: [{ label: "半分(175g)", amountG: 175 }, { label: "1杯(350g)", amountG: 350 }] },
  { id: "kaisen_don",       name: "海鮮丼",       category: "prepared_food", image: "/images/foods/kaisendon.png",       water: 65, sodium: 200, potassium: 200, phosphorus: 150,
    portions: [{ label: "半分(200g)", amountG: 200 }, { label: "1杯(400g)", amountG: 400 }] },

  // ── ごはん系 ────────────────────────────────────────────────
  { id: "okayu",            name: "おかゆ",       category: "grain",         image: "/images/foods/Rice Porridge (Okayu).png",            water: 90, sodium:   1, potassium:  15, phosphorus:  18,
  ...
  { id: "takikomi_gohan",   name: "炊き込みご飯", category: "grain",         image: "/images/foods/takikomi-gohan.png",   water: 62, sodium: 200, potassium:  80, phosphorus:  70,
    portions: [{ label: "少なめ(100g)", amountG: 100 }, { label: "普通(150g)", amountG: 150 }, { label: "大盛り(250g)", amountG: 250 }] },
  { id: "chirashi_sushi",   name: "ちらし寿司",   category: "grain",         image: "/images/foods/chirashi-sushi.png",   water: 63, sodium: 300, potassium: 180, phosphorus: 150,
    portions: [{ label: "半分(150g)", amountG: 150 }, { label: "1人前(250g)", amountG: 250 }] },
  { id: "maki_sushi",       name: "巻き寿司",     category: "grain",         image: "/images/foods/maki-sushi.png",       water: 58, sodium: 350, potassium: 120, phosphorus:  80,
    portions: [{ label: "2切れ(60g)", amountG: 60 }, { label: "4切れ(120g)", amountG: 120 }, { label: "8切れ(240g)", amountG: 240 }] },

  // ── 鶏肉料理 ────────────────────────────────────────────────
  { id: "teriyaki_chicken", name: "照り焼きチキン", category: "prepared_food", image: "/images/foods/teriyaki-chicken.png", water: 62, sodium: 550, potassium: 310, phosphorus: 220,
  ...
  { id: "shio_yaki_chicken",name: "鶏の塩焼き",   category: "prepared_food", image: "/images/foods/grilled-salted-chicken.png",water: 65, sodium: 350, potassium: 300, phosphorus: 210,
    portions: [{ label: "少なめ(80g)", amountG: 80 }, { label: "普通(120g)", amountG: 120 }] },
  { id: "chicken_nanban",   name: "チキン南蛮",   category: "prepared_food", image: "/images/foods/chicken-nanban.png",   water: 58, sodium: 550, potassium: 280, phosphorus: 200,
  ...
  { id: "oyako_ni",         name: "親子煮",       category: "prepared_food", image: "/images/foods/oyakodon.png",         water: 75, sodium: 500, potassium: 200, phosphorus: 170,
  ...
  { id: "ice_cream",        name: "アイスクリーム", category: "prepared_food", image: "/images/foods/ice-cream.png",        water: 60, sodium:  75, potassium: 150, phosphorus: 110,
