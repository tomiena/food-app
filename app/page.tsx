...
type FoodBtn  = { foodId: string; image: string; label: string; portions: Portion[] };

// Noto Emoji PNG via Google CDN — rendered as <img>, not text emoji
const ni = (hex: string) => `https://fonts.gstatic.com/s/e/notoemoji/latest/${hex}/512.png`;
...
const CATEGORIES: Category[] = [
  {
    name: "⭐ よく使う",
    items: [
      { foodId: "rice",      image: ni("1f35a"), label: "白米",    portions: [{ label:"1杯",   grams:150 },{ label:"半分",   grams:75  },{ label:"大盛",  grams:200 }] },
      { foodId: "miso_soup", image: ni("1f963"), label: "みそ汁",  portions: [{ label:"1杯",   grams:150 },{ label:"半分",   grams:75  }] },
      { foodId: "egg",       image: ni("1f95a"), label: "卵",      portions: [{ label:"1個",   grams:60  },{ label:"2個",   grams:120 }] },
      { foodId: "tofu_m",    image: ni("1fad8"), label: "豆腐",    portions: [{ label:"半丁",  grams:150 },{ label:"1/4丁", grams:75  }] },
      { foodId: "chicken_b", image: ni("1f357"), label: "鶏むね肉",portions: [{ label:"1切れ", grams:80  },{ label:"2切れ", grams:160 },{ label:"半分",  grams:40  }] },
      { foodId: "cabbage",   image: ni("1f96c"), label: "キャベツ",portions: [{ label:"1皿",   grams:80  },{ label:"たっぷり",grams:120 },{ label:"少量",  grams:40  }] },
      { foodId: "tomato",    image: ni("1f345"), label: "トマト",  portions: [{ label:"1個",   grams:120 },{ label:"半分",   grams:60  }] },
      { foodId: "apple",     image: ni("1f34e"), label: "りんご",  portions: [{ label:"1/2個", grams:120 },{ label:"1/4個", grams:60  }] },
    ],
  },
  {
    name: "🍚 主食・麺",
    items: [
      { foodId: "rice",         image: ni("1f35a"), label: "白米",        portions: [{ label:"1杯",   grams:150 },{ label:"半分",  grams:75  },{ label:"大盛",  grams:200 }] },
      { foodId: "brown_rice",   image: ni("1f35a"), label: "玄米",        portions: [{ label:"1杯",   grams:150 },{ label:"半分",  grams:75  }] },
      { foodId: "onigiri",      image: ni("1f359"), label: "おにぎり",    portions: [{ label:"1個",   grams:100 },{ label:"2個",   grams:200 }] },
      { foodId: "fried_rice",   image: ni("1f958"), label: "チャーハン",  portions: [{ label:"1杯",   grams:200 },{ label:"半分",  grams:100 }] },
      { foodId: "curry_rice",   image: ni("1f35b"), label: "カレーライス",portions: [{ label:"1皿",   grams:250 },{ label:"半分",  grams:125 }] },
      { foodId: "bread",        image: ni("1f35e"), label: "食パン",      portions: [{ label:"1枚",   grams:60  },{ label:"2枚",   grams:120 }] },
      { foodId: "udon",         image: ni("1f35c"), label: "うどん",      portions: [{ label:"1杯",   grams:200 },{ label:"半分",  grams:100 }] },
      { foodId: "soba",         image: ni("1f35d"), label: "そば",        portions: [{ label:"1杯",   grams:200 },{ label:"半分",  grams:100 }] },
      { foodId: "ramen",        image: ni("1f35c"), label: "ラーメン",    portions: [{ label:"1杯",   grams:400 },{ label:"麺だけ",grams:200 }] },
      { foodId: "spaghetti",    image: ni("1f35d"), label: "スパゲティ",  portions: [{ label:"1人前", grams:200 },{ label:"半分",  grams:100 }] },
      { foodId: "rice_porridge",image: ni("1f963"), label: "お粥",        portions: [{ label:"1杯",   grams:200 },{ label:"半分",  grams:100 }] },
      { foodId: "yakisoba",     image: ni("1f958"), label: "焼きそば",    portions: [{ label:"1皿",   grams:200 },{ label:"半分",  grams:100 }] },
    ],
  },
  {
    name: "🥣 汁物",
    items: [
      { foodId: "miso_soup",    image: ni("1f963"), label: "みそ汁",        portions: [{ label:"全部飲んだ",grams:150 },{ label:"半分",grams:75 },{ label:"残した",grams:20 }] },
      { foodId: "consomme",     image: ni("1f372"), label: "コンソメスープ", portions: [{ label:"全部飲んだ",grams:150 },{ label:"半分",grams:75 },{ label:"残した",grams:20 }] },
      { foodId: "chinese_soup", image: ni("1f35c"), label: "中華スープ",     portions: [{ label:"全部飲んだ",grams:150 },{ label:"半分",grams:75 },{ label:"残した",grams:20 }] },
      { foodId: "potage",       image: ni("1f963"), label: "ポタージュ",     portions: [{ label:"全部飲んだ",grams:150 },{ label:"半分",grams:75 },{ label:"残した",grams:20 }] },
      { foodId: "tonjiru",      image: ni("1f372"), label: "豚汁",           portions: [{ label:"全部飲んだ",grams:150 },{ label:"半分",grams:75 },{ label:"残した",grams:20 }] },
      { foodId: "stew",         image: ni("1f372"), label: "シチュー",       portions: [{ label:"全部",grams:150 },{ label:"半分",grams:75 },{ label:"少量",grams:40 }] },
    ],
    warning: "⚠️ 汁物は塩分が多めです。飲む量を少なめにすると体が楽になります。",
    showRiskLegend: true,
  },
  {
    name: "🥤 飲み物",
    items: [
      { foodId: "water_drink",     image: ni("1f4a7"), label: "水",              portions: [{ label:"コップ1杯",grams:200 },{ label:"半分",grams:100 },{ label:"ペット小",grams:500 }] },
      { foodId: "green_tea",       image: ni("1f375"), label: "お茶（緑茶）",    portions: [{ label:"コップ1杯",grams:200 },{ label:"半分",grams:100 }] },
      { foodId: "barley_tea",      image: ni("1f375"), label: "麦茶",            portions: [{ label:"コップ1杯",grams:200 },{ label:"半分",grams:100 }] },
      { foodId: "coffee",          image: ni("2615"),  label: "コーヒー",        portions: [{ label:"1杯",grams:150 },{ label:"大きめ",grams:250 }] },
      { foodId: "milk_latte",      image: ni("2615"),  label: "カフェラテ",      portions: [{ label:"1杯",grams:250 },{ label:"小さめ",grams:150 }] },
      { foodId: "cocoa",           image: ni("2615"),  label: "ココア",          portions: [{ label:"1杯",grams:200 },{ label:"小さめ",grams:150 }] },
      { foodId: "soy_milk",        image: ni("1f95b"), label: "豆乳",            portions: [{ label:"1パック",grams:200 },{ label:"半分",grams:100 }] },
      { foodId: "milk",            image: ni("1f95b"), label: "牛乳",            portions: [{ label:"1杯",grams:200 },{ label:"半分",grams:100 }] },
      { foodId: "orange_juice",    image: ni("1f34a"), label: "オレンジジュース",portions: [{ label:"1杯",grams:200 },{ label:"小さめ",grams:100 }] },
      { foodId: "fruit_juice",     image: ni("1f9c3"), label: "100%果汁",        portions: [{ label:"1杯",grams:200 },{ label:"小さめ",grams:100 }] },
      { foodId: "vegetable_juice", image: ni("1f9c3"), label: "野菜ジュース",    portions: [{ label:"1本",grams:200 },{ label:"半分",grams:100 }] },
      { foodId: "sports_drink",    image: ni("1f964"), label: "スポーツドリンク",portions: [{ label:"1本",grams:500 },{ label:"半分",grams:250 }] },
      { foodId: "cola",            image: ni("1f964"), label: "コーラ",          portions: [{ label:"缶1本",grams:350 },{ label:"コップ1杯",grams:200 }] },
      { foodId: "carbonated_juice",image: ni("1f964"), label: "炭酸ジュース",    portions: [{ label:"缶1本",grams:350 },{ label:"コップ1杯",grams:200 }] },
      { foodId: "beer",            image: ni("1f37a"), label: "ビール",          portions: [{ label:"中ジョッキ",grams:350 },{ label:"缶1本",grams:350 },{ label:"小",grams:200 }] },
      { foodId: "sake",            image: ni("1f376"), label: "日本酒",          portions: [{ label:"1合",grams:180 },{ label:"半合",grams:90 }] },
      { foodId: "shochu",          image: ni("1f943"), label: "焼酎",            portions: [{ label:"1杯（水割り）",grams:100 },{ label:"ロック",grams:60 }] },
      { foodId: "wine_red",        image: ni("1f377"), label: "赤ワイン",        portions: [{ label:"1杯",grams:120 },{ label:"半分",grams:60 }] },
      { foodId: "wine_white",      image: ni("1f942"), label: "白ワイン",        portions: [{ label:"1杯",grams:120 },{ label:"半分",grams:60 }] },
      { foodId: "whisky",          image: ni("1f943"), label: "ウイスキー",      portions: [{ label:"シングル",grams:30 },{ label:"ダブル",grams:60 }] },
    ],
  },
  {
    name: "🍖 肉類",
    items: [
      { foodId: "chicken_b",    image: ni("1f357"), label: "鶏むね肉",  portions: [{ label:"1切れ",  grams:80  },{ label:"2切れ",grams:160 },{ label:"半分",grams:40 }] },
      { foodId: "chicken_t",    image: ni("1f357"), label: "鶏もも肉",  portions: [{ label:"1切れ",  grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "sasami",       image: ni("1f357"), label: "鶏ささみ",   portions: [{ label:"1本",    grams:60  },{ label:"2本",  grams:120 }] },
      { foodId: "pork_loin",    image: ni("1f969"), label: "豚ロース",   portions: [{ label:"1切れ",  grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "pork_belly",   image: ni("1f953"), label: "豚バラ",     portions: [{ label:"1切れ",  grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "beef",         image: ni("1f969"), label: "牛もも肉",   portions: [{ label:"1切れ",  grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "beef_belly",   image: ni("1f969"), label: "牛バラ",     portions: [{ label:"1切れ",  grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "minced",       image: ni("1f969"), label: "ひき肉",     portions: [{ label:"大さじ3",grams:50  },{ label:"100g",grams:100 }] },
      { foodId: "liver_chicken",image: ni("1f357"), label: "鶏レバー",   portions: [{ label:"50g",    grams:50  },{ label:"100g",grams:100 }] },
      { foodId: "liver_pork",   image: ni("1f969"), label: "豚レバー",   portions: [{ label:"50g",    grams:50  },{ label:"100g",grams:100 }] },
      { foodId: "lamb",         image: ni("1f969"), label: "ラム肉",     portions: [{ label:"1切れ",  grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "chicken_wing", image: ni("1f357"), label: "手羽元",     portions: [{ label:"2本",    grams:80  },{ label:"4本",  grams:160 }] },
      { foodId: "duck",         image: ni("1f357"), label: "鴨肉",       portions: [{ label:"1切れ",  grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "pork_shoulder",image: ni("1f969"), label: "豚肩ロース", portions: [{ label:"1切れ",  grams:80  },{ label:"2切れ",grams:160 }] },
    ],
    showRiskLegend: true,
  },
  {
    name: "🐟 魚類",
    items: [
      { foodId: "salmon",        image: ni("1f420"), label: "さけ（生）",  portions: [{ label:"1切れ",grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "salmon_salt",   image: ni("1f420"), label: "塩さけ",      portions: [{ label:"1切れ",grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "mackerel",      image: ni("1f41f"), label: "さば",        portions: [{ label:"1切れ",grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "aji",           image: ni("1f41f"), label: "あじ",        portions: [{ label:"1切れ",grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "iwashi",        image: ni("1f41f"), label: "いわし",      portions: [{ label:"1匹", grams:80  },{ label:"2匹", grams:160 }] },
      { foodId: "tuna",          image: ni("1f421"), label: "まぐろ",      portions: [{ label:"1切れ",grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "buri",          image: ni("1f41f"), label: "ぶり",        portions: [{ label:"1切れ",grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "tai",           image: ni("1f421"), label: "たい",        portions: [{ label:"1切れ",grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "cod",           image: ni("1f41f"), label: "たら",        portions: [{ label:"1切れ",grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "flatfish",      image: ni("1f421"), label: "ひらめ",      portions: [{ label:"1切れ",grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "shrimp",        image: ni("1f990"), label: "えび",        portions: [{ label:"5尾",  grams:80  },{ label:"10尾", grams:160 }] },
      { foodId: "squid",         image: ni("1f991"), label: "いか",        portions: [{ label:"1/2杯",grams:80  },{ label:"1杯",  grams:160 }] },
      { foodId: "octopus",       image: ni("1f419"), label: "たこ",        portions: [{ label:"50g", grams:50  },{ label:"100g", grams:100 }] },
      { foodId: "oyster",        image: ni("1f9aa"), label: "かき（牡蠣）",portions: [{ label:"3個", grams:60  },{ label:"6個",  grams:120 }] },
      { foodId: "scallop",       image: ni("1f41a"), label: "ほたて",      portions: [{ label:"2個",  grams:80  },{ label:"4個",  grams:160 }] },
      { foodId: "canned_mackerel",image: ni("1f41f"),label: "さば缶",      portions: [{ label:"1/2缶",grams:95  },{ label:"1缶",  grams:190 }] },
      { foodId: "canned_tuna",   image: ni("1f420"), label: "ツナ缶",      portions: [{ label:"1/2缶",grams:70  },{ label:"1缶",  grams:140 }] },
      { foodId: "dried_fish",    image: ni("1f41f"), label: "ひもの",      portions: [{ label:"1枚", grams:80  },{ label:"2枚",  grams:160 }] },
      { foodId: "yakizakana",    image: ni("1f41f"), label: "焼き魚",      portions: [{ label:"1切れ",grams:80  },{ label:"2切れ",grams:160 }] },
    ],
    showRiskLegend: true,
  },
  {
    ...
    items: [
      { foodId: "egg",       image: ni("1f95a"), label: "卵",      portions: [{ label:"1個",    grams:60  },{ label:"2個",    grams:120 }] },
      { foodId: "tofu_m",    image: ni("1fad8"), label: "豆腐（木綿）",portions: [{ label:"半丁",grams:150 },{ label:"1/4丁",  grams:75  }] },
      { foodId: "tofu_k",    image: ni("1fad8"), label: "絹豆腐",  portions: [{ label:"半丁",   grams:150 },{ label:"1/4丁",  grams:75  }] },
      { foodId: "natto",     image: ni("1fad8"), label: "納豆",    portions: [{ label:"1パック",grams:40  },{ label:"2パック",grams:80  }] },
      { foodId: "abura_age", image: ni("1f373"), label: "油揚げ",  portions: [{ label:"1枚",    grams:30  },{ label:"2枚",    grams:60  }] },
      { foodId: "atsuage",   image: ni("1f373"), label: "厚揚げ",  portions: [{ label:"1/2個",  grams:100 },{ label:"1個",    grams:200 }] },
      { foodId: "ganmodoki", image: ni("1f9c6"), label: "がんもどき",portions: [{ label:"1個",  grams:80  },{ label:"2個",    grams:160 }] },
      { foodId: "edamame",   image: ni("1fad8"), label: "枝豆",    portions: [{ label:"ひとつまみ",grams:50},{ label:"多め",   grams:100 }] },
      { foodId: "soy_beans", image: ni("1fad8"), label: "大豆（ゆで）",portions: [{ label:"大さじ2",grams:30},{ label:"50g",  grams:50  }] },
    ],
  },
  {
    name: "🥦 野菜",
    items: [
      { foodId: "cabbage",        image: ni("1f96c"), label: "キャベツ",    portions: [{ label:"1皿",   grams:80  },{ label:"たっぷり",grams:120 },{ label:"少量",grams:40  }] },
      { foodId: "cucumber",       image: ni("1f952"), label: "きゅうり",    portions: [{ label:"1本",   grams:100 },{ label:"半分",    grams:50  }] },
      { foodId: "tomato",         image: ni("1f345"), label: "トマト",      portions: [{ label:"1個",   grams:120 },{ label:"半分",    grams:60  }] },
      { foodId: "broccoli",       image: ni("1f966"), label: "ブロッコリー",portions: [{ label:"1房",   grams:80  },{ label:"2房",     grams:160 }] },
      { foodId: "lettuce",        image: ni("1f96c"), label: "レタス",      portions: [{ label:"1枚",   grams:30  },{ label:"3枚",     grams:90  }] },
      { foodId: "moyashi",        image: ni("1f331"), label: "もやし",      portions: [{ label:"1皿",   grams:80  },{ label:"半袋",    grams:100 }] },
      { foodId: "eggplant",       image: ni("1f346"), label: "なす",        portions: [{ label:"1本",   grams:80  },{ label:"半分",    grams:40  }] },
      { foodId: "green_pepper",   image: ni("1fad1"), label: "ピーマン",    portions: [{ label:"1個",   grams:30  },{ label:"2個",     grams:60  }] },
      { foodId: "chinese_cabbage",image: ni("1f96c"), label: "白菜",        portions: [{ label:"1皿",   grams:80  },{ label:"たっぷり",grams:150 }] },
      { foodId: "daikon",         image: ni("1f9c5"), label: "大根",        portions: [{ label:"1皿",   grams:80  },{ label:"厚切り",  grams:120 }] },
      { foodId: "onion",          image: ni("1f9c5"), label: "玉ねぎ",      portions: [{ label:"1/2個", grams:80  },{ label:"1個",     grams:160 }] },
      { foodId: "carrot",         image: ni("1f955"), label: "にんじん",    portions: [{ label:"1/3本", grams:50  },{ label:"1/2本",   grams:80  }] },
      { foodId: "pumpkin",        image: ni("1f34e"), label: "かぼちゃ",    portions: [{ label:"1切れ", grams:80  },{ label:"2切れ",   grams:160 }] },
      { foodId: "potato",         image: ni("1f954"), label: "じゃがいも",  portions: [{ label:"1個",   grams:100 },{ label:"半分",    grams:50  }] },
      { foodId: "sweet_potato",   image: ni("1f360"), label: "さつまいも",  portions: [{ label:"1/3本", grams:80  },{ label:"半分",    grams:120 }] },
      { foodId: "spinach",        image: ni("1f96c"), label: "ほうれん草",  portions: [{ label:"1皿",   grams:80  },{ label:"たっぷり",grams:120 }] },
      { foodId: "komatsuna",      image: ni("1f966"), label: "小松菜",      portions: [{ label:"1皿",   grams:80  },{ label:"たっぷり",grams:120 }] },
      { foodId: "shiitake",       image: ni("1f344_200d_1f7eb"), label: "しいたけ",portions: [{ label:"2枚",grams:40 },{ label:"4枚",grams:80 }] },
      { foodId: "enoki",          image: ni("1f331"), label: "えのき",      portions: [{ label:"1袋",   grams:100 },{ label:"半袋",    grams:50  }] },
      { foodId: "corn",           image: ni("1f33d"), label: "とうもろこし",portions: [{ label:"1/2本", grams:120 },{ label:"1本",     grams:240 }] },
      { foodId: "asparagus",      image: ni("1f966"), label: "アスパラガス",portions: [{ label:"3本",   grams:60  },{ label:"5本",     grams:100 }] },
      { foodId: "celery",         image: ni("1f966"), label: "セロリ",      portions: [{ label:"1本",   grams:80  },{ label:"2本",     grams:160 }] },
      { foodId: "burdock",        image: ni("1f33f"), label: "ごぼう",      portions: [{ label:"1/3本", grams:50  },{ label:"1/2本",   grams:80  }] },
      { foodId: "lotus_root",     image: ni("1f9c5"), label: "れんこん",    portions: [{ label:"1節",   grams:80  },{ label:"半分",    grams:40  }] },
      { foodId: "chives",         image: ni("1f96c"), label: "にら",        portions: [{ label:"1皿",   grams:60  },{ label:"たっぷり",grams:100 }] },
      { foodId: "bamboo_shoot",   image: ni("1f966"), label: "たけのこ",    portions: [{ label:"50g",   grams:50  },{ label:"100g",    grams:100 }] },
      { foodId: "okra",           image: ni("1f966"), label: "オクラ",      portions: [{ label:"3本",   grams:30  },{ label:"5本",     grams:50  }] },
      { foodId: "green_beans",    image: ni("1fad8"), label: "いんげん",    portions: [{ label:"1皿",   grams:60  },{ label:"たっぷり",grams:100 }] },
      { foodId: "shungiku",       image: ni("1f33f"), label: "春菊",        portions: [{ label:"1皿",   grams:80  },{ label:"たっぷり",grams:120 }] },
      { foodId: "taro",           image: ni("1f954"), label: "里いも",      portions: [{ label:"2個",   grams:80  },{ label:"4個",     grams:160 }] },
    ],
    showRiskLegend: true,
  },
  {
    ...
    items: [
      { foodId: "apple",       image: ni("1f34e"), label: "りんご",      portions: [{ label:"1/2個",grams:120 },{ label:"1/4個",grams:60  }] },
      { foodId: "mikan",       image: ni("1f34a"), label: "みかん",      portions: [{ label:"1個",  grams:100 },{ label:"2個",  grams:200 }] },
      { foodId: "pear",        image: ni("1f350"), label: "なし",        portions: [{ label:"1/2個",grams:100 },{ label:"1/4個",grams:50  }] },
      { foodId: "peach",       image: ni("1f351"), label: "もも",        portions: [{ label:"1個",  grams:200 },{ label:"半分", grams:100 }] },
      { foodId: "watermelon",  image: ni("1f349"), label: "すいか",      portions: [{ label:"1切れ",grams:150 },{ label:"2切れ",grams:300 }] },
      { foodId: "strawberry",  image: ni("1f353"), label: "いちご",      portions: [{ label:"5粒",  grams:75  },{ label:"10粒", grams:150 }] },
      { foodId: "grape",       image: ni("1f347"), label: "ぶどう",      portions: [{ label:"一房", grams:150 },{ label:"半房", grams:75  }] },
      { foodId: "banana",      image: ni("1f34c"), label: "バナナ",      portions: [{ label:"1本",  grams:100 },{ label:"半分", grams:50  }] },
      { foodId: "kiwi",        image: ni("1f95d"), label: "キウイ",      portions: [{ label:"1個",  grams:100 },{ label:"半分", grams:50  }] },
      { foodId: "melon",       image: ni("1f348"), label: "メロン",      portions: [{ label:"1切れ",grams:150 },{ label:"2切れ",grams:300 }] },
      { foodId: "pineapple",   image: ni("1f34d"), label: "パイナップル",portions: [{ label:"1切れ",grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "mango",       image: ni("1f96d"), label: "マンゴー",    portions: [{ label:"1/2個",grams:100 },{ label:"1個",  grams:200 }] },
      { foodId: "grapefruit",  image: ni("1f34a"), label: "グレープフルーツ",portions: [{ label:"1/2個",grams:150 },{ label:"1個",grams:300 }] },
      { foodId: "fig",         image: ni("1f351"), label: "いちじく",    portions: [{ label:"1個",  grams:60  },{ label:"2個",  grams:120 }] },
      { foodId: "persimmon",   image: ni("1f34a"), label: "柿",          portions: [{ label:"1個",  grams:160 },{ label:"半分", grams:80  }] },
      { foodId: "lemon",       image: ni("1f34b"), label: "レモン",      portions: [{ label:"1/4個",grams:25  },{ label:"1/2個",grams:50  }] },
    ],
    showRiskLegend: true,
  },
  {
    name: "🍱 調理済み",
    items: [
      { foodId: "karaage",       image: ni("1f357"), label: "から揚げ",   portions: [{ label:"3個",  grams:90  },{ label:"5個",  grams:150 }] },
      { foodId: "tamagoyaki",    image: ni("1f373"), label: "玉子焼き",   portions: [{ label:"1切れ",grams:50  },{ label:"2切れ",grams:100 }] },
      { foodId: "hamburger",     image: ni("1f354"), label: "ハンバーグ", portions: [{ label:"1個",  grams:120 },{ label:"半分", grams:60  }] },
      { foodId: "tonkatsu",      image: ni("1f969"), label: "とんかつ",   portions: [{ label:"1切れ",grams:100 },{ label:"2切れ",grams:200 }] },
      { foodId: "croquette",     image: ni("1f9c6"), label: "コロッケ",   portions: [{ label:"1個",  grams:70  },{ label:"2個",  grams:140 }] },
      { foodId: "yakitori",      image: ni("1f357"), label: "焼き鳥",     portions: [{ label:"2本",  grams:60  },{ label:"4本",  grams:120 }] },
      { foodId: "gyudon",        image: ni("1f35a"), label: "牛丼",       portions: [{ label:"1杯",  grams:300 },{ label:"半分", grams:150 }] },
      { foodId: "oyakodon",      image: ni("1f373"), label: "親子丼",     portions: [{ label:"1杯",  grams:300 },{ label:"半分", grams:150 }] },
      { foodId: "niku_jaga",     image: ni("1f372"), label: "肉じゃが",   portions: [{ label:"1皿",  grams:150 },{ label:"半分", grams:75  }] },
      { foodId: "chawanmushi",   image: ni("1f95a"), label: "茶碗蒸し",   portions: [{ label:"1個",  grams:150 },{ label:"半分", grams:75  }] },
      { foodId: "sushi_nigiri",  image: ni("1f363"), label: "にぎり寿司", portions: [{ label:"2貫",  grams:60  },{ label:"5貫",  grams:150 }] },
      { foodId: "tempura_shrimp",image: ni("1f364"), label: "エビ天ぷら", portions: [{ label:"2本",  grams:70  },{ label:"3本",  grams:105 }] },
      { foodId: "tempura_veg",   image: ni("1f966"), label: "野菜天ぷら", portions: [{ label:"2個",  grams:80  },{ label:"4個",  grams:160 }] },
      { foodId: "mapo_tofu",     image: ni("1f372"), label: "麻婆豆腐",   portions: [{ label:"1皿",  grams:150 },{ label:"半分", grams:75  }] },
    ],
    warning: "⚠️ 調理品は塩分・脂質が多めのことがあります。量で調整してみてください。",
    showRiskLegend: true,
  },
  {
    name: "🥫 加工食品",
    items: [
      { foodId: "ham",             image: ni("1f356"), label: "ハム",         portions: [{ label:"1枚",  grams:20  },{ label:"3枚",  grams:60  }] },
      { foodId: "wiener",          image: ni("1f32d"), label: "ウインナー",   portions: [{ label:"1本",  grams:20  },{ label:"3本",  grams:60  }] },
      { foodId: "bacon",           image: ni("1f953"), label: "ベーコン",     portions: [{ label:"1枚",  grams:20  },{ label:"3枚",  grams:60  }] },
      { foodId: "sausage",         image: ni("1f32d"), label: "ソーセージ",   portions: [{ label:"1本",  grams:30  },{ label:"2本",  grams:60  }] },
      { foodId: "kamaboko",        image: ni("1f41f"), label: "かまぼこ",     portions: [{ label:"2切れ",grams:40  },{ label:"4切れ",grams:80  }] },
      { foodId: "chikuwa",         image: ni("1f9c4"), label: "ちくわ",       portions: [{ label:"1本",  grams:30  },{ label:"2本",  grams:60  }] },
      { foodId: "hanpen",          image: ni("1f9c1"), label: "はんぺん",     portions: [{ label:"1/2枚",grams:55  },{ label:"1枚",  grams:110 }] },
      { foodId: "satsuma_age",     image: ni("1f41f"), label: "さつま揚げ",   portions: [{ label:"1枚",  grams:60  },{ label:"2枚",  grams:120 }] },
      { foodId: "instant_noodles", image: ni("1f35c"), label: "インスタント麺",portions: [{ label:"1袋", grams:100 }] },
    ],
    warning: "⚠️ 加工食品は塩分が多く含まれています。少量でもしっかり記録しましょう。",
    showRiskLegend: true,
  },
  {
    name: "🧂 調味料",
    items: [
      { foodId: "soy_tbsp",      image: ni("1f376"), label: "醤油",          portions: [{ label:"少々",   grams:5   },{ label:"小さじ1",grams:6  },{ label:"大さじ1",grams:18 }] },
      { foodId: "miso_tbsp",     image: ni("1f372"), label: "みそ",          portions: [{ label:"小さじ1",grams:6   },{ label:"大さじ1",grams:18 }] },
      { foodId: "salt_tsp",      image: ni("1f9c2"), label: "塩",            portions: [{ label:"少々",   grams:1   },{ label:"小さじ1",grams:6  }] },
      { foodId: "mayonnaise",    image: ni("1f95a"), label: "マヨネーズ",    portions: [{ label:"小さじ1",grams:5   },{ label:"大さじ1",grams:15 }] },
      { foodId: "ketchup",       image: ni("1f345"), label: "ケチャップ",    portions: [{ label:"小さじ1",grams:5   },{ label:"大さじ1",grams:15 }] },
      { foodId: "worcestershire", image: ni("1f376"), label: "ウスターソース",portions: [{ label:"小さじ1",grams:5   },{ label:"大さじ1",grams:15 }] },
      { foodId: "vinegar",       image: ni("1f376"), label: "酢",            portions: [{ label:"小さじ1",grams:5   },{ label:"大さじ1",grams:15 }] },
      { foodId: "dressing",      image: ni("1f96c"), label: "ドレッシング",  portions: [{ label:"小さじ2",grams:10  },{ label:"大さじ1",grams:15 }] },
      { foodId: "cheese",        image: ni("1f9c0"), label: "チーズ",        portions: [{ label:"1枚",    grams:20  },{ label:"2枚",    grams:40  }] },
      { foodId: "yogurt",        image: ni("1f963"), label: "ヨーグルト",    portions: [{ label:"1個",    grams:100 },{ label:"半分",   grams:50  }] },
      { foodId: "butter",        image: ni("1f9c8"), label: "バター",        portions: [{ label:"5g",     grams:5   },{ label:"10g",    grams:10  }] },
      { foodId: "cream",         image: ni("1f9c8"), label: "生クリーム",    portions: [{ label:"大さじ1",grams:15  },{ label:"大さじ3",grams:45  }] },
    ],
  },
];
...
function FoodButton({ btn, onTap, disabled }: { btn: FoodBtn; onTap: () => void; disabled?: boolean }) {
  ...
  return (
    ...
    >
      ...
      <img src={btn.image} alt={btn.label} width={44} height={44} style={{ objectFit: "contain", display: "block" }} />
    ...
    <>
      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", marginBottom: 20 }}>
          <img src={btn.image} alt={btn.label} width={64} height={64} style={{ objectFit: "contain", display: "block", margin: "0 auto" }} />
