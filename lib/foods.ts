...
export const FOODS: Food[] = [
  ...
  { id: "reduced_salt_soy", name: "減塩醤油",       category: "seasoning",     image: "/images/foods/reduced_salt_soy.png", water: 67, sodium: 3500, potassium: 390, phosphorus: 150,
  ...
  { id: "soy_milk",         name: "豆乳（無調整）", category: "drink", image: "/images/foods/soy_milk.png",         water: 91, sodium:   2, potassium: 190, phosphorus:  55,
    portions: [{ label: "半分(100ml)", amountG: 100 }, { label: "コップ1杯(200ml)", amountG: 200 }, { label: "350ml", amountG: 350 }] },
  { id: "drinking_yogurt",  name: "飲むヨーグルト", category: "drink", image: "/images/foods/drinking_yogurt.png",  water: 85, sodium:  50, potassium: 180, phosphorus: 100,
    portions: [{ label: "半分(100ml)", amountG: 100 }, { label: "コップ1杯(200ml)", amountG: 200 }] },
  { id: "sports_drink",     name: "スポーツドリンク", category: "drink", image: "/images/foods/sports_drink.png",  water: 94, sodium:  49, potassium:  20, phosphorus:   5,
    portions: [{ label: "半分(250ml)", amountG: 250 }, { label: "1本(500ml)", amountG: 500 }] },
  { id: "sparkling_water",  name: "炭酸水",         category: "drink", image: "/images/foods/sparkling_water.png",  water: 100, sodium:  0, potassium:   0, phosphorus:   0,
    portions: [{ label: "半分(250ml)", amountG: 250 }, { label: "1本(500ml)", amountG: 500 }] },
  { id: "lemon_water",      name: "レモン水",       category: "drink", image: "/images/foods/lemon_water.png",      water: 99, sodium:   0, potassium:  10, phosphorus:   2,
    portions: [{ label: "コップ1杯(200ml)", amountG: 200 }, { label: "350ml", amountG: 350 }] },
  { id: "lactic_drink",     name: "乳酸菌飲料",     category: "drink", image: "/images/foods/lactic_drink.png",     water: 75, sodium:  50, potassium:  40, phosphorus:  30,
    portions: [{ label: "小瓶(65ml)", amountG: 65 }, { label: "大瓶(130ml)", amountG: 130 }] },
  { id: "milk_tea",         name: "ミルクティー",   category: "drink", image: "/images/foods/milk_tea.png",         water: 92, sodium:  30, potassium:  80, phosphorus:  40,
    portions: [{ label: "カップ1杯(150ml)", amountG: 150 }, { label: "コップ1杯(200ml)", amountG: 200 }] },
  { id: "canned_coffee",    name: "缶コーヒー",     category: "drink", image: "/images/foods/canned_coffee.png",    water: 90, sodium:  30, potassium:  60, phosphorus:  30,
    portions: [{ label: "缶1本(185ml)", amountG: 185 }, { label: "大缶(250ml)", amountG: 250 }] },
  { id: "veggie_smoothie",  name: "野菜スムージー", category: "drink", image: "/images/foods/veggie_smoothie.png",  water: 87, sodium:  50, potassium: 250, phosphorus:  30,
    portions: [{ label: "半分(125ml)", amountG: 125 }, { label: "1本(250ml)", amountG: 250 }] },

  // ── meat 追加分 ────────────────────────────────────────────
  { id: "chicken_sasami",   name: "鶏ささみ",       category: "meat", image: "/images/foods/chicken_sasami.png",   water: 75, sodium:  40, potassium: 410, phosphorus: 220,
    portions: [{ label: "1本(50g)", amountG: 50 }, { label: "2本(100g)", amountG: 100 }, { label: "3本(150g)", amountG: 150 }] },
  { id: "chicken_wing_tip", name: "手羽先",         category: "meat", image: "/images/foods/chicken_wing_tip.png", water: 70, sodium:  70, potassium: 200, phosphorus: 170,
    portions: [{ label: "1本(60g)", amountG: 60 }, { label: "3本(180g)", amountG: 180 }] },
  { id: "chicken_wing_root",name: "手羽元",         category: "meat", image: "/images/foods/chicken_wing_root.png",water: 68, sodium:  70, potassium: 240, phosphorus: 190,
    portions: [{ label: "1本(80g)", amountG: 80 }, { label: "2本(160g)", amountG: 160 }] },
  { id: "ground_chicken",   name: "鶏ひき肉",       category: "meat", image: "/images/foods/ground_chicken.png",   water: 70, sodium:  60, potassium: 290, phosphorus: 190,
    portions: [{ label: "少なめ(80g)", amountG: 80 }, { label: "普通(100g)", amountG: 100 }, { label: "多め(150g)", amountG: 150 }] },
  { id: "pork_thin",        name: "豚こま肉",       category: "meat", image: "/images/foods/pork_thin.png",        water: 64, sodium:  60, potassium: 290, phosphorus: 180,
    portions: [{ label: "少なめ(80g)", amountG: 80 }, { label: "普通(100g)", amountG: 100 }, { label: "多め(150g)", amountG: 150 }] },
  { id: "pork_belly",       name: "豚バラ肉",       category: "meat", image: "/images/foods/pork_belly.png",       water: 53, sodium:  60, potassium: 250, phosphorus: 130,
    portions: [{ label: "少なめ(80g)", amountG: 80 }, { label: "普通(100g)", amountG: 100 }, { label: "多め(150g)", amountG: 150 }] },
  { id: "pork_loin",        name: "豚ロース",       category: "meat", image: "/images/foods/pork_loin.png",        water: 63, sodium:  55, potassium: 310, phosphorus: 200,
    portions: [{ label: "1枚(80g)", amountG: 80 }, { label: "大きめ1枚(120g)", amountG: 120 }] },
  { id: "beef_thin",        name: "牛こま肉",       category: "meat", image: "/images/foods/beef_thin.png",        water: 60, sodium:  60, potassium: 290, phosphorus: 170,
    portions: [{ label: "少なめ(80g)", amountG: 80 }, { label: "普通(100g)", amountG: 100 }, { label: "多め(150g)", amountG: 150 }] },
  { id: "beef_sliced",      name: "牛薄切り肉",     category: "meat", image: "/images/foods/beef_sliced.png",      water: 68, sodium:  60, potassium: 290, phosphorus: 175,
    portions: [{ label: "少なめ(80g)", amountG: 80 }, { label: "普通(100g)", amountG: 100 }, { label: "多め(150g)", amountG: 150 }] },
  { id: "mixed_ground",     name: "合いびき肉",     category: "meat", image: "/images/foods/mixed_ground.png",     water: 60, sodium:  65, potassium: 280, phosphorus: 165,
    portions: [{ label: "少なめ(80g)", amountG: 80 }, { label: "普通(100g)", amountG: 100 }, { label: "多め(150g)", amountG: 150 }] },
  ...
  { id: "sausage",          name: "ソーセージ",     category: "meat", image: "/images/foods/sausage.png",          water: 55, sodium: 740, potassium: 220, phosphorus: 130,
  ...
  // ── fish 追加分 ────────────────────────────────────────────
  { id: "grilled_salmon",   name: "さけ（焼き）",   category: "fish", image: "/images/foods/grilled_salmon.png",   water: 65, sodium:  70, potassium: 320, phosphorus: 260,
    portions: [{ label: "1切れ(80g)", amountG: 80 }, { label: "大きめ(120g)", amountG: 120 }] },
  { id: "salted_salmon",    name: "さけ（塩鮭）",   category: "fish", image: "/images/foods/salted_salmon.png",    water: 55, sodium: 1100, potassium: 300, phosphorus: 220,
    portions: [{ label: "1切れ(80g)", amountG: 80 }, { label: "大きめ(120g)", amountG: 120 }] },
  { id: "grilled_mackerel", name: "さば（焼き）",   category: "fish", image: "/images/foods/grilled_mackerel.png", water: 57, sodium: 130, potassium: 300, phosphorus: 250,
    portions: [{ label: "1切れ(80g)", amountG: 80 }, { label: "大きめ(120g)", amountG: 120 }] },
  { id: "aji",              name: "あじ",           category: "fish", image: "/images/foods/aji.png",              water: 73, sodium: 120, potassium: 360, phosphorus: 220,
    portions: [{ label: "小1尾(70g)", amountG: 70 }, { label: "1尾(100g)", amountG: 100 }] },
  { id: "buri",             name: "ぶり",           category: "fish", image: "/images/foods/buri.png",             water: 67, sodium:  65, potassium: 380, phosphorus: 130,
    portions: [{ label: "1切れ(80g)", amountG: 80 }, { label: "大きめ(120g)", amountG: 120 }] },
  { id: "tara",             name: "たら",           category: "fish", image: "/images/foods/tara.png",             water: 81, sodium: 130, potassium: 350, phosphorus: 220,
    portions: [{ label: "1切れ(80g)", amountG: 80 }, { label: "大きめ(120g)", amountG: 120 }] },
  { id: "sanma",            name: "さんま",         category: "fish", image: "/images/foods/sanma.png",            water: 55, sodium: 130, potassium: 200, phosphorus: 180,
    portions: [{ label: "1尾(120g)", amountG: 120 }] },
  { id: "shishamo",         name: "ししゃも",       category: "fish", image: "/images/foods/shishamo.png",         water: 72, sodium: 520, potassium: 280, phosphorus: 390,
    portions: [{ label: "2尾(40g)", amountG: 40 }, { label: "4尾(80g)", amountG: 80 }] },
  { id: "shirasu",          name: "しらす",         category: "fish", image: "/images/foods/shirasu.png",          water: 86, sodium: 300, potassium: 200, phosphorus: 200,
    portions: [{ label: "小匙2(10g)", amountG: 10 }, { label: "大匙1(15g)", amountG: 15 }, { label: "大匙3(40g)", amountG: 40 }] },
  { id: "tuna_can",         name: "ツナ缶",         category: "fish", image: "/images/foods/tuna_can.png",         water: 85, sodium: 230, potassium: 230, phosphorus: 170,
    portions: [{ label: "半分(40g)", amountG: 40 }, { label: "1缶(80g)", amountG: 80 }] },
  { id: "mackerel_can",     name: "さば缶",         category: "fish", image: "/images/foods/mackerel_can.png",     water: 72, sodium: 450, potassium: 270, phosphorus: 200,
    portions: [{ label: "半分(100g)", amountG: 100 }, { label: "1缶(200g)", amountG: 200 }] },
  { id: "sardine_can",      name: "いわし缶",       category: "fish", image: "/images/foods/sardine_can.png",      water: 70, sodium: 400, potassium: 280, phosphorus: 220,
    portions: [{ label: "半分(75g)", amountG: 75 }, { label: "1缶(150g)", amountG: 150 }] },
  { id: "tako",             name: "たこ",           category: "fish", image: "/images/foods/tako.png",             water: 81, sodium: 280, potassium: 290, phosphorus: 160,
  ...
  // ── vegetable 追加分 ───────────────────────────────────────
  { id: "mushroom",         name: "きのこ類",       category: "vegetable",     image: "/images/foods/mushroom.png",        water: 91, sodium:   2, potassium: 290, phosphorus: 100,
