...
const CATEGORIES: Category[] = [
  {
    name: "⭐ よく使う",
    items: [
      { foodId: "rice", label: "白米",    portions: [{ label:"1杯",   grams:150 },{ label:"半分",   grams:75  },{ label:"大盛",  grams:200 }] },
      { foodId: "miso_soup", label: "みそ汁",  portions: [{ label:"1杯",   grams:150 },{ label:"半分",   grams:75  }] },
      { foodId: "egg", label: "卵",      portions: [{ label:"1個",   grams:60  },{ label:"2個",   grams:120 }] },
      { foodId: "tofu_m", label: "豆腐",    portions: [{ label:"半丁",  grams:150 },{ label:"1/4丁", grams:75  }] },
      { foodId: "chicken_b", label: "鶏むね肉",portions: [{ label:"1切れ", grams:80  },{ label:"2切れ", grams:160 },{ label:"半分",  grams:40  }] },
      { foodId: "cabbage", label: "キャベツ",portions: [{ label:"1皿",   grams:80  },{ label:"たっぷり",grams:120 },{ label:"少量",  grams:40  }] },
      { foodId: "tomato", label: "トマト",  portions: [{ label:"1個",   grams:120 },{ label:"半分",   grams:60  }] },
      { foodId: "apple", label: "りんご",  portions: [{ label:"1/2個", grams:120 },{ label:"1/4個", grams:60  }] },
    ],
  },
  {
    name: "🍚 主食・麺",
    items: [
      { foodId: "rice", label: "白米",        portions: [{ label:"1杯",   grams:150 },{ label:"半分",  grams:75  },{ label:"大盛",  grams:200 }] },
      { foodId: "brown_rice", label: "玄米",        portions: [{ label:"1杯",   grams:150 },{ label:"半分",  grams:75  }] },
      { foodId: "onigiri", label: "おにぎり",    portions: [{ label:"1個",   grams:100 },{ label:"2個",   grams:200 }] },
      { foodId: "fried_rice", label: "チャーハン",  portions: [{ label:"1杯",   grams:200 },{ label:"半分",  grams:100 }] },
      { foodId: "curry_rice", label: "カレーライス",portions: [{ label:"1皿",   grams:250 },{ label:"半分",  grams:125 }] },
      { foodId: "bread", label: "食パン",      portions: [{ label:"1枚",   grams:60  },{ label:"2枚",   grams:120 }] },
      { foodId: "udon", label: "うどん",      portions: [{ label:"1杯",   grams:200 },{ label:"半分",  grams:100 }] },
      { foodId: "soba", label: "そば",        portions: [{ label:"1杯",   grams:200 },{ label:"半分",  grams:100 }] },
      { foodId: "ramen", label: "ラーメン",    portions: [{ label:"1杯",   grams:400 },{ label:"麺だけ",grams:200 }] },
      { foodId: "spaghetti", label: "スパゲティ",  portions: [{ label:"1人前", grams:200 },{ label:"半分",  grams:100 }] },
      { foodId: "rice_porridge", label: "お粥",        portions: [{ label:"1杯",   grams:200 },{ label:"半分",  grams:100 }] },
      { foodId: "yakisoba", label: "焼きそば",    portions: [{ label:"1皿",   grams:200 },{ label:"半分",  grams:100 }] },
    ],
  },
  {
    name: "🥣 汁物",
    items: [
      { foodId: "miso_soup", label: "みそ汁",        portions: [{ label:"全部飲んだ",grams:150 },{ label:"半分",grams:75 },{ label:"残した",grams:20 }] },
      { foodId: "consomme", label: "コンソメスープ", portions: [{ label:"全部飲んだ",grams:150 },{ label:"半分",grams:75 },{ label:"残した",grams:20 }] },
      { foodId: "chinese_soup", label: "中華スープ",     portions: [{ label:"全部飲んだ",grams:150 },{ label:"半分",grams:75 },{ label:"残した",grams:20 }] },
      { foodId: "potage", label: "ポタージュ",     portions: [{ label:"全部飲んだ",grams:150 },{ label:"半分",grams:75 },{ label:"残した",grams:20 }] },
      { foodId: "tonjiru", label: "豚汁",           portions: [{ label:"全部飲んだ",grams:150 },{ label:"半分",grams:75 },{ label:"残した",grams:20 }] },
      { foodId: "stew", label: "シチュー",       portions: [{ label:"全部",grams:150 },{ label:"半分",grams:75 },{ label:"少量",grams:40 }] },
    ],
  ...
  },
  {
    name: "🥤 飲み物",
    items: [
      { foodId: "water_drink", label: "水",              portions: [{ label:"コップ1杯",grams:200 },{ label:"半分",grams:100 },{ label:"ペット小",grams:500 }] },
      { foodId: "green_tea", label: "お茶（緑茶）",    portions: [{ label:"コップ1杯",grams:200 },{ label:"半分",grams:100 }] },
      { foodId: "barley_tea", label: "麦茶",            portions: [{ label:"コップ1杯",grams:200 },{ label:"半分",grams:100 }] },
      { foodId: "coffee",  label: "コーヒー",        portions: [{ label:"1杯",grams:150 },{ label:"大きめ",grams:250 }] },
      { foodId: "milk_latte",  label: "カフェラテ",      portions: [{ label:"1杯",grams:250 },{ label:"小さめ",grams:150 }] },
      { foodId: "cocoa",  label: "ココア",          portions: [{ label:"1杯",grams:200 },{ label:"小さめ",grams:150 }] },
      { foodId: "soy_milk", label: "豆乳",            portions: [{ label:"1パック",grams:200 },{ label:"半分",grams:100 }] },
      { foodId: "milk", label: "牛乳",            portions: [{ label:"1杯",grams:200 },{ label:"半分",grams:100 }] },
      { foodId: "orange_juice", label: "オレンジジュース",portions: [{ label:"1杯",grams:200 },{ label:"小さめ",grams:100 }] },
      { foodId: "fruit_juice", label: "100%果汁",        portions: [{ label:"1杯",grams:200 },{ label:"小さめ",grams:100 }] },
      { foodId: "vegetable_juice", label: "野菜ジュース",    portions: [{ label:"1本",grams:200 },{ label:"半分",grams:100 }] },
      { foodId: "sports_drink", label: "スポーツドリンク",portions: [{ label:"1本",grams:500 },{ label:"半分",grams:250 }] },
      { foodId: "cola", label: "コーラ",          portions: [{ label:"缶1本",grams:350 },{ label:"コップ1杯",grams:200 }] },
      { foodId: "carbonated_juice", label: "炭酸ジュース",    portions: [{ label:"缶1本",grams:350 },{ label:"コップ1杯",grams:200 }] },
      { foodId: "beer", label: "ビール",          portions: [{ label:"中ジョッキ",grams:350 },{ label:"缶1本",grams:350 },{ label:"小",grams:200 }] },
      { foodId: "sake", label: "日本酒",          portions: [{ label:"1合",grams:180 },{ label:"半合",grams:90 }] },
      { foodId: "shochu", label: "焼酎",            portions: [{ label:"1杯（水割り）",grams:100 },{ label:"ロック",grams:60 }] },
      { foodId: "wine_red", label: "赤ワイン",        portions: [{ label:"1杯",grams:120 },{ label:"半分",grams:60 }] },
      { foodId: "wine_white", label: "白ワイン",        portions: [{ label:"1杯",grams:120 },{ label:"半分",grams:60 }] },
      { foodId: "whisky", label: "ウイスキー",      portions: [{ label:"シングル",grams:30 },{ label:"ダブル",grams:60 }] },
    ],
  },
  {
    name: "🍖 肉類",
    items: [
      { foodId: "chicken_b", label: "鶏むね肉",  portions: [{ label:"1切れ",  grams:80  },{ label:"2切れ",grams:160 },{ label:"半分",grams:40 }] },
      { foodId: "chicken_t", label: "鶏もも肉",  portions: [{ label:"1切れ",  grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "sasami", label: "鶏ささみ",   portions: [{ label:"1本",    grams:60  },{ label:"2本",  grams:120 }] },
      { foodId: "pork_loin", label: "豚ロース",   portions: [{ label:"1切れ",  grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "pork_belly", label: "豚バラ",     portions: [{ label:"1切れ",  grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "beef", label: "牛もも肉",   portions: [{ label:"1切れ",  grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "beef_belly", label: "牛バラ",     portions: [{ label:"1切れ",  grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "minced", label: "ひき肉",     portions: [{ label:"大さじ3",grams:50  },{ label:"100g",grams:100 }] },
      { foodId: "liver_chicken", label: "鶏レバー",   portions: [{ label:"50g",    grams:50  },{ label:"100g",grams:100 }] },
      { foodId: "liver_pork", label: "豚レバー",   portions: [{ label:"50g",    grams:50  },{ label:"100g",grams:100 }] },
      { foodId: "lamb", label: "ラム肉",     portions: [{ label:"1切れ",  grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "chicken_wing", label: "手羽元",     portions: [{ label:"2本",    grams:80  },{ label:"4本",  grams:160 }] },
      { foodId: "duck", label: "鴨肉",       portions: [{ label:"1切れ",  grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "pork_shoulder", label: "豚肩ロース", portions: [{ label:"1切れ",  grams:80  },{ label:"2切れ",grams:160 }] },
    ],
    showRiskLegend: true,
  },
  {
    name: "🐟 魚類",
    items: [
      { foodId: "salmon", label: "さけ（生）",  portions: [{ label:"1切れ",grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "salmon_salt", label: "塩さけ",      portions: [{ label:"1切れ",grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "mackerel", label: "さば",        portions: [{ label:"1切れ",grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "aji", label: "あじ",        portions: [{ label:"1切れ",grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "iwashi", label: "いわし",      portions: [{ label:"1匹", grams:80  },{ label:"2匹", grams:160 }] },
      { foodId: "tuna", label: "まぐろ",      portions: [{ label:"1切れ",grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "buri", label: "ぶり",        portions: [{ label:"1切れ",grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "tai", label: "たい",        portions: [{ label:"1切れ",grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "cod", label: "たら",        portions: [{ label:"1切れ",grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "flatfish", label: "ひらめ",      portions: [{ label:"1切れ",grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "shrimp", label: "えび",        portions: [{ label:"5尾",  grams:80  },{ label:"10尾", grams:160 }] },
      { foodId: "squid", label: "いか",        portions: [{ label:"1/2杯",grams:80  },{ label:"1杯",  grams:160 }] },
      { foodId: "octopus", label: "たこ",        portions: [{ label:"50g", grams:50  },{ label:"100g", grams:100 }] },
      { foodId: "oyster", label: "かき（牡蠣）",portions: [{ label:"3個", grams:60  },{ label:"6個",  grams:120 }] },
      { foodId: "scallop", label: "ほたて",      portions: [{ label:"2個",  grams:80  },{ label:"4個",  grams:160 }] },
      { foodId: "canned_mackerel",label: "さば缶",      portions: [{ label:"1/2缶",grams:95  },{ label:"1缶",  grams:190 }] },
      { foodId: "canned_tuna", label: "ツナ缶",      portions: [{ label:"1/2缶",grams:70  },{ label:"1缶",  grams:140 }] },
      { foodId: "dried_fish", label: "ひもの",      portions: [{ label:"1枚", grams:80  },{ label:"2枚",  grams:160 }] },
      { foodId: "yakizakana", label: "焼き魚",      portions: [{ label:"1切れ",grams:80  },{ label:"2切れ",grams:160 }] },
    ],
    showRiskLegend: true,
  },
  {
    ...
    items: [
      { foodId: "egg", label: "卵",      portions: [{ label:"1個",    grams:60  },{ label:"2個",    grams:120 }] },
      { foodId: "tofu_m", label: "豆腐（木綿）",portions: [{ label:"半丁",grams:150 },{ label:"1/4丁",  grams:75  }] },
      { foodId: "tofu_k", label: "絹豆腐",  portions: [{ label:"半丁",   grams:150 },{ label:"1/4丁",  grams:75  }] },
      { foodId: "natto", label: "納豆",    portions: [{ label:"1パック",grams:40  },{ label:"2パック",grams:80  }] },
      { foodId: "abura_age", label: "油揚げ",  portions: [{ label:"1枚",    grams:30  },{ label:"2枚",    grams:60  }] },
      { foodId: "atsuage", label: "厚揚げ",  portions: [{ label:"1/2個",  grams:100 },{ label:"1個",    grams:200 }] },
      { foodId: "ganmodoki", label: "がんもどき",portions: [{ label:"1個",  grams:80  },{ label:"2個",    grams:160 }] },
      { foodId: "edamame", label: "枝豆",    portions: [{ label:"ひとつまみ",grams:50},{ label:"多め",   grams:100 }] },
      { foodId: "soy_beans", label: "大豆（ゆで）",portions: [{ label:"大さじ2",grams:30},{ label:"50g",  grams:50  }] },
    ],
  },
  {
    name: "🥦 野菜",
    items: [
      { foodId: "cabbage", label: "キャベツ",    portions: [{ label:"1皿",   grams:80  },{ label:"たっぷり",grams:120 },{ label:"少量",grams:40  }] },
      { foodId: "cucumber", label: "きゅうり",    portions: [{ label:"1本",   grams:100 },{ label:"半分",    grams:50  }] },
      { foodId: "tomato", label: "トマト",      portions: [{ label:"1個",   grams:120 },{ label:"半分",    grams:60  }] },
      { foodId: "broccoli", label: "ブロッコリー",portions: [{ label:"1房",   grams:80  },{ label:"2房",     grams:160 }] },
      { foodId: "lettuce", label: "レタス",      portions: [{ label:"1枚",   grams:30  },{ label:"3枚",     grams:90  }] },
      { foodId: "moyashi", label: "もやし",      portions: [{ label:"1皿",   grams:80  },{ label:"半袋",    grams:100 }] },
      { foodId: "eggplant", label: "なす",        portions: [{ label:"1本",   grams:80  },{ label:"半分",    grams:40  }] },
      { foodId: "green_pepper", label: "ピーマン",    portions: [{ label:"1個",   grams:30  },{ label:"2個",     grams:60  }] },
      { foodId: "chinese_cabbage", label: "白菜",        portions: [{ label:"1皿",   grams:80  },{ label:"たっぷり",grams:150 }] },
      { foodId: "daikon", label: "大根",        portions: [{ label:"1皿",   grams:80  },{ label:"厚切り",  grams:120 }] },
      { foodId: "onion", label: "玉ねぎ",      portions: [{ label:"1/2個", grams:80  },{ label:"1個",     grams:160 }] },
      { foodId: "carrot", label: "にんじん",    portions: [{ label:"1/3本", grams:50  },{ label:"1/2本",   grams:80  }] },
      { foodId: "pumpkin", label: "かぼちゃ",    portions: [{ label:"1切れ", grams:80  },{ label:"2切れ",   grams:160 }] },
      { foodId: "potato", label: "じゃがいも",  portions: [{ label:"1個",   grams:100 },{ label:"半分",    grams:50  }] },
      { foodId: "sweet_potato", label: "さつまいも",  portions: [{ label:"1/3本", grams:80  },{ label:"半分",    grams:120 }] },
      { foodId: "spinach", label: "ほうれん草",  portions: [{ label:"1皿",   grams:80  },{ label:"たっぷり",grams:120 }] },
      { foodId: "komatsuna", label: "小松菜",      portions: [{ label:"1皿",   grams:80  },{ label:"たっぷり",grams:120 }] },
      { foodId: "shiitake", label: "しいたけ",portions: [{ label:"2枚",grams:40 },{ label:"4枚",grams:80 }] },
      { foodId: "enoki", label: "えのき",      portions: [{ label:"1袋",   grams:100 },{ label:"半袋",    grams:50  }] },
      { foodId: "corn", label: "とうもろこし",portions: [{ label:"1/2本", grams:120 },{ label:"1本",     grams:240 }] },
      { foodId: "asparagus", label: "アスパラガス",portions: [{ label:"3本",   grams:60  },{ label:"5本",     grams:100 }] },
      { foodId: "celery", label: "セロリ",      portions: [{ label:"1本",   grams:80  },{ label:"2本",     grams:160 }] },
      { foodId: "burdock", label: "ごぼう",      portions: [{ label:"1/3本", grams:50  },{ label:"1/2本",   grams:80  }] },
      { foodId: "lotus_root", label: "れんこん",    portions: [{ label:"1節",   grams:80  },{ label:"半分",    grams:40  }] },
      { foodId: "chives", label: "にら",        portions: [{ label:"1皿",   grams:60  },{ label:"たっぷり",grams:100 }] },
      { foodId: "bamboo_shoot", label: "たけのこ",    portions: [{ label:"50g",   grams:50  },{ label:"100g",    grams:100 }] },
      { foodId: "okra", label: "オクラ",      portions: [{ label:"3本",   grams:30  },{ label:"5本",     grams:50  }] },
      { foodId: "green_beans", label: "いんげん",    portions: [{ label:"1皿",   grams:60  },{ label:"たっぷり",grams:100 }] },
      { foodId: "shungiku", label: "春菊",        portions: [{ label:"1皿",   grams:80  },{ label:"たっぷり",grams:120 }] },
      { foodId: "taro", label: "里いも",      portions: [{ label:"2個",   grams:80  },{ label:"4個",     grams:160 }] },
    ],
    showRiskLegend: true,
  },
  {
    ...
    items: [
      { foodId: "apple", label: "りんご",      portions: [{ label:"1/2個",grams:120 },{ label:"1/4個",grams:60  }] },
      { foodId: "mikan", label: "みかん",      portions: [{ label:"1個",  grams:100 },{ label:"2個",  grams:200 }] },
      { foodId: "pear", label: "なし",        portions: [{ label:"1/2個",grams:100 },{ label:"1/4個",grams:50  }] },
      { foodId: "peach", label: "もも",        portions: [{ label:"1個",  grams:200 },{ label:"半分", grams:100 }] },
      { foodId: "watermelon", label: "すいか",      portions: [{ label:"1切れ",grams:150 },{ label:"2切れ",grams:300 }] },
      { foodId: "strawberry", label: "いちご",      portions: [{ label:"5粒",  grams:75  },{ label:"10粒", grams:150 }] },
      { foodId: "grape", label: "ぶどう",      portions: [{ label:"一房", grams:150 },{ label:"半房", grams:75  }] },
      { foodId: "banana", label: "バナナ",      portions: [{ label:"1本",  grams:100 },{ label:"半分", grams:50  }] },
      { foodId: "kiwi", label: "キウイ",      portions: [{ label:"1個",  grams:100 },{ label:"半分", grams:50  }] },
      { foodId: "melon", label: "メロン",      portions: [{ label:"1切れ",grams:150 },{ label:"2切れ",grams:300 }] },
      { foodId: "pineapple", label: "パイナップル",portions: [{ label:"1切れ",grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "mango", label: "マンゴー",    portions: [{ label:"1/2個",grams:100 },{ label:"1個",  grams:200 }] },
      { foodId: "grapefruit", label: "グレープフルーツ",portions: [{ label:"1/2個",grams:150 },{ label:"1個",grams:300 }] },
      { foodId: "fig", label: "いちじく",    portions: [{ label:"1個",  grams:60  },{ label:"2個",  grams:120 }] },
      { foodId: "persimmon", label: "柿",          portions: [{ label:"1個",  grams:160 },{ label:"半分", grams:80  }] },
      { foodId: "lemon", label: "レモン",      portions: [{ label:"1/4個",grams:25  },{ label:"1/2個",grams:50  }] },
    ],
    showRiskLegend: true,
  },
  {
    name: "🍱 調理済み",
    items: [
      { foodId: "karaage", label: "から揚げ",   portions: [{ label:"3個",  grams:90  },{ label:"5個",  grams:150 }] },
      { foodId: "tamagoyaki", label: "玉子焼き",   portions: [{ label:"1切れ",grams:50  },{ label:"2切れ",grams:100 }] },
      { foodId: "hamburger", label: "ハンバーグ", portions: [{ label:"1個",  grams:120 },{ label:"半分", grams:60  }] },
      { foodId: "tonkatsu", label: "とんかつ",   portions: [{ label:"1切れ",grams:100 },{ label:"2切れ",grams:200 }] },
      { foodId: "croquette", label: "コロッケ",   portions: [{ label:"1個",  grams:70  },{ label:"2個",  grams:140 }] },
      { foodId: "yakitori", label: "焼き鳥",     portions: [{ label:"2本",  grams:60  },{ label:"4本",  grams:120 }] },
      { foodId: "gyudon", label: "牛丼",       portions: [{ label:"1杯",  grams:300 },{ label:"半分", grams:150 }] },
      { foodId: "oyakodon", label: "親子丼",     portions: [{ label:"1杯",  grams:300 },{ label:"半分", grams:150 }] },
      { foodId: "niku_jaga", label: "肉じゃが",   portions: [{ label:"1皿",  grams:150 },{ label:"半分", grams:75  }] },
      { foodId: "chawanmushi", label: "茶碗蒸し",   portions: [{ label:"1個",  grams:150 },{ label:"半分", grams:75  }] },
      { foodId: "sushi_nigiri", label: "にぎり寿司", portions: [{ label:"2貫",  grams:60  },{ label:"5貫",  grams:150 }] },
      { foodId: "tempura_shrimp", label: "エビ天ぷら", portions: [{ label:"2本",  grams:70  },{ label:"3本",  grams:105 }] },
      { foodId: "tempura_veg", label: "野菜天ぷら", portions: [{ label:"2個",  grams:80  },{ label:"4個",  grams:160 }] },
      { foodId: "mapo_tofu", label: "麻婆豆腐",   portions: [{ label:"1皿",  grams:150 },{ label:"半分", grams:75  }] },
    ],
  ...
  },
  {
    name: "🥫 加工食品",
    items: [
      { foodId: "ham", label: "ハム",         portions: [{ label:"1枚",  grams:20  },{ label:"3枚",  grams:60  }] },
      { foodId: "wiener", label: "ウインナー",   portions: [{ label:"1本",  grams:20  },{ label:"3本",  grams:60  }] },
      { foodId: "bacon", label: "ベーコン",     portions: [{ label:"1枚",  grams:20  },{ label:"3枚",  grams:60  }] },
      { foodId: "sausage", label: "ソーセージ",   portions: [{ label:"1本",  grams:30  },{ label:"2本",  grams:60  }] },
      { foodId: "kamaboko", label: "かまぼこ",     portions: [{ label:"2切れ",grams:40  },{ label:"4切れ",grams:80  }] },
      { foodId: "chikuwa", label: "ちくわ",       portions: [{ label:"1本",  grams:30  },{ label:"2本",  grams:60  }] },
      { foodId: "hanpen", label: "はんぺん",     portions: [{ label:"1/2枚",grams:55  },{ label:"1枚",  grams:110 }] },
      { foodId: "satsuma_age", label: "さつま揚げ",   portions: [{ label:"1枚",  grams:60  },{ label:"2枚",  grams:120 }] },
      { foodId: "instant_noodles", label: "インスタント麺",portions: [{ label:"1袋", grams:100 }] },
    ],
  ...
  },
  {
    name: "🧂 調味料",
    items: [
      { foodId: "soy_tbsp", label: "醤油",          portions: [{ label:"少々",   grams:5   },{ label:"小さじ1",grams:6  },{ label:"大さじ1",grams:18 }] },
      { foodId: "miso_tbsp", label: "みそ",          portions: [{ label:"小さじ1",grams:6   },{ label:"大さじ1",grams:18 }] },
      { foodId: "salt_tsp", label: "塩",            portions: [{ label:"少々",   grams:1   },{ label:"小さじ1",grams:6  }] },
      { foodId: "mayonnaise", label: "マヨネーズ",    portions: [{ label:"小さじ1",grams:5   },{ label:"大さじ1",grams:15 }] },
      { foodId: "ketchup", label: "ケチャップ",    portions: [{ label:"小さじ1",grams:5   },{ label:"大さじ1",grams:15 }] },
      { foodId: "worcestershire", label: "ウスターソース",portions: [{ label:"小さじ1",grams:5   },{ label:"大さじ1",grams:15 }] },
      { foodId: "vinegar", label: "酢",            portions: [{ label:"小さじ1",grams:5   },{ label:"大さじ1",grams:15 }] },
      { foodId: "dressing", label: "ドレッシング",  portions: [{ label:"小さじ2",grams:10  },{ label:"大さじ1",grams:15 }] },
      { foodId: "cheese", label: "チーズ",        portions: [{ label:"1枚",    grams:20  },{ label:"2枚",    grams:40  }] },
      { foodId: "yogurt", label: "ヨーグルト",    portions: [{ label:"1個",    grams:100 },{ label:"半分",   grams:50  }] },
      { foodId: "butter", label: "バター",        portions: [{ label:"5g",     grams:5   },{ label:"10g",    grams:10  }] },
      { foodId: "cream", label: "生クリーム",    portions: [{ label:"大さじ1",grams:15  },{ label:"大さじ3",grams:45  }] },
    ],
  },
];
